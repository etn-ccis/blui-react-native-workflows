...
import { RegistrationContext, RegistrationContextType } from '../../contexts/RegistrationContextProvider';
/**
 * @ignore
 */
    ...
    return (
        ...
        >
            ...
            >
                ...
                />
                <DemoRegistrationStack.Screen
                    name="DemoCreateAccountScreen"
                    component={DemoCreateAccountScreen}
                    options={{
                        gestureDirection: 'vertical',
                    }}
                />
