...
import { DemoCreateAccountScreen } from '../DemoCreateAccountScreen';
import { Screen2 } from '../Screen2';
import { EulaScreen } from '../EulaScreen';
/**
 * @ignore
 */
const DemoRegistrationStack = createStackNavigator();
...
export const DemoRegistrationScreen: React.FC<React.PropsWithChildren<any>> = (props) => {
    ...
    return (
        <>
            ...
            <DemoRegistrationStack.Navigator initialRouteName='EulaScreen' screenOptions={
                {

                    gestureDirection: 'vertical'
                }
            }>
                <DemoRegistrationStack.Screen name="EulaScreen" component={EulaScreen} options={
                {

                    gestureDirection: 'vertical'
                }
            }/>
            <DemoRegistrationStack.Screen name="DemoCreateAccountScreen" component={DemoCreateAccountScreen} options={
                {

                    gestureDirection: 'vertical'
                }}/>
                <DemoRegistrationStack.Screen name="Screen2" component={Screen2} options={
                {
