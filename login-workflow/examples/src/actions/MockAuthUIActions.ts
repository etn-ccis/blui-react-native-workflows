...
import { AuthUIActions, SecurityContextActions } from '@etn-sst/react-native-auth-ui';
...
function isRandomFailure(): boolean {
    const randomResponseNumber = getRandomInt(2);
 ...
 */
const MockAuthUIActions: AuthUIActionsWithSecurity = (securityHelper) => (): AuthUIActions => ({
    /**
...
export default MockAuthUIActions;
